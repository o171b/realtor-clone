...
return (
     ...
     <main>
      ...
      >
        ...
        max-w-6xl lg:mx-auto p-4 rounded-lg shadow-lg bg-white lg:space-x-5'>
          
          <div className='w-full h-[200px] lg-[400px]'>
            <p className='text-2xl font-bold mb-3 text-blue-900'>
              {listing.description} - $ {listing.offer ? 
            ...
            <div className='flex justify-start items-center space-x-4 w-[75%]'>
              ...
              {listing.offer && (
                <p className='w-full max-w-[200px] bg-green-800 rounded-md p-1 
                text-white text-center font-semibold shadow-md '>
