...
export default function CreateListing() {
    ...
    const onSubmit = async (e)=> {
        ...
        if (geoLocationEnabled){
            ...
            if (typeof location === "string" && location.includes("undefined")){
                setLoading(false);
    ...
    <main className='max-w-md px-2 mx-auto'>
        ...
        <div className='flex mb-6'>
            ...
            <div className='mb-6'>
                ...
                multiple
                required
                className='className="w-full px-3 py-1.5 text-gray-700
                 bg-white border border-gray-300 rounded transition duration-150 
                 ease-in-out focus:bg-white focus:borer-slate-600'
                />
            </div>
